...
EasyBuy allows users to:
- register and authenticate
- browse products
- add products to the cart
- perform a demo checkout process
- enable seller mode
...
The purchase functionality is implemented in a demo format, as payment system integration was outside the scope of this project.
